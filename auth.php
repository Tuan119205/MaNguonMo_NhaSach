<?php
	...
	if (isset($_SESSION['err_register']) || isset($_SESSION['success_register'])) {
		$authTab = 'register';
	}
...
<div class="container-fluid auth-page">
	<div class="auth-shell">
		...
		<div class="tab-content" id="loginRegisterContent">
			<div class="tab-pane fade <?php echo $authTab === 'login' ? 'show active' : ''; ?>" id="login" role="tabpanel" aria-labelledby="login-tab">
				<?php if(isset($_SESSION['err_login'])): ?>
					<div class="alert alert-danger auth-alert">
						<i class="fas fa-exclamation-circle"></i> <?= $_SESSION['err_login'] ?>
					</div>
				...
				<form class="auth-form" method="post" action="login_verify.php">
					...
					<button type="submit" name="submit" class="auth-submit">Sign in</button>
				</form>
			</div>
			...
			<div class="tab-pane fade <?php echo $authTab === 'register' ? 'show active' : ''; ?>" id="register" role="tabpanel" aria-labelledby="register-tab">
				<?php if(isset($_SESSION['err_register'])): ?>
					<div class="alert alert-danger auth-alert">
						<i class="fas fa-exclamation-circle"></i> <?= $_SESSION['err_register'] ?>
					</div>
				...
				<?php if(isset($_SESSION['success_register'])): ?>
					<div class="alert alert-success auth-alert">
						<i class="fas fa-check-circle"></i> <?= $_SESSION['success_register'] ?>
					</div>
				...
				<form class="auth-form" method="post" action="register_verify.php">
					...
					<button type="submit" name="submit" class="auth-submit auth-submit-register">Create account</button>
				</form>
				<?php endif; ?>
			</div>
		</div>
		...
		<div class="auth-toggle-wrap">
			<button class="auth-toggle <?php echo $authTab === 'login' ? 'active' : ''; ?>" type="button" data-bs-toggle="tab" data-bs-target="#login" data-target="login" id="login-tab">Sign in</button>
			<button class="auth-toggle <?php echo $authTab === 'register' ? 'active' : ''; ?>" type="button" data-bs-toggle="tab" data-bs-target="#register" data-target="register" id="register-tab">Register</button>
		</div>
	</div>
</div>
